  ...
  return (
    <div className='ml-16'>
      ...
      <div>
        ...
        <div className='mt-10'>
          <Link className="bg-red-900 text-red-500 hover:bg-red-800 hover:text-white bg-opacity-30 p-1 rounded-md text-base" href='/codeeditor'>Click here to test your code 💻</Link>
        </div>
      </div>
    </div>
  );
